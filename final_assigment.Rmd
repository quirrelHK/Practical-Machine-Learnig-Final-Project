...
* https://github.com/quirrelHK/Practical-Machine-Learnig-Final-Project
...
The real source of this data  is http://web.archive.org/web/20161224072740/http:/groupware.les.inf.puc-rio.br/har. (Please, If you use the document you create for this class for any purpose please cite them as they have been very generous in allowing their data to be used for this kind of assignment.)
...
```{r load, echo=TRUE}
train <- vroom("C:\\Users\\ritesh\\Downloads\\pml-training.csv", delim = ",", 
               na=c("NA","#DIV/0!", ""))

test <- vroom("C:\\Users\\ritesh\\Downloads\\pml-testing.csv", delim = ",",
              na=c("NA","#DIV/0!", ""))
